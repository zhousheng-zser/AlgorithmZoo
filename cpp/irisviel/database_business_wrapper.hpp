...
namespace glasssix
{
	namespace irisviel
	{
		...
		public:
			...
			database_business_wrapper(face_service_implemention implementation, const std::shared_ptr<database_feature_observer>& observer, std::string_view map_file_path, std::string_view cache_directory, std::string_view lsh_directory);
