#ifndef _FLAME_BOX_INFO_HPP_
#define _FLAME_BOX_INFO_HPP_
...
{
    template<>
    struct abi<flame::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "{90551819-B21F-4821-91FF-6EB181B1E1B4}" };
    ...
    struct interface_vtable<Derived, flame::box_info> : interface_vtable_base<Derived, flame::box_info>
    {
    ...
    template <>
    struct abi_adapter<flame::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, flame::box_info>
        {
