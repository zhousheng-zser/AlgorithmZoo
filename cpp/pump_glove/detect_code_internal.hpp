#ifndef __PUMP_GLOVE_DETECT_CODE_INTERNAL_HPP__
#define __PUMP_GLOVE_DETECT_CODE_INTERNAL_HPP__
...
namespace glasssix::pump_glove
{
    ...
    public:
        ...
        exposing::param_vector<pump_glove::box_info> detect(exposing::param_span<std::uint8_t> bitmap, int channels, int height, int width, int roi_x, int roi_y, int roi_width, int roi_height, std::map<std::string, float>& param_map) const;
