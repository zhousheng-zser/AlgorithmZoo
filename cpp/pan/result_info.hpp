...
namespace glasssix::pan
{
    struct result_info_internal
    {
        ...
        exposing::param_vector<int> num;
        exposing::param_vector<float> speed;
    };
}
...
namespace glasssix::exposing::impl
{
    ...
    struct interface_vtable<Derived, pan::result_info> : interface_vtable_base<Derived, pan::result_info>
    {
    ...
    template <>
    struct abi_adapter<pan::result_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pan::result_info>
        {
