...
namespace glasssix::pan
{
    ...
    exposing::param_vector<int> result_info_impl::num() const
    {
        return internal_.num;
    }
    exposing::param_vector<float> result_info_impl::speed() const
    {
        return internal_.speed;
    }
}