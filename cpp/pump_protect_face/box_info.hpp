#ifndef _pump_protect_face_BOX_INFO_HPP_
#define _pump_protect_face_BOX_INFO_HPP_
...
{
    template<>
    struct abi<pump_protect_face::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "DE046AA2-97A3-338E-B6FF-40015B12486A" };
    ...
    struct interface_vtable<Derived, pump_protect_face::box_info> : interface_vtable_base<Derived, pump_protect_face::box_info>
    {
    ...
    template <>
    struct abi_adapter<pump_protect_face::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_protect_face::box_info>
        {
