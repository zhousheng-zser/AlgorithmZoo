#ifndef __PUMP_MASK_DETECT_CODE_INTERNAL_HPP__
#define __PUMP_MASK_DETECT_CODE_INTERNAL_HPP__
...
namespace glasssix::pump_protect_face
{
    ...
    public:
        ...
        exposing::param_vector<pump_protect_face::box_info> detect(exposing::param_span<std::uint8_t> bitmap,
