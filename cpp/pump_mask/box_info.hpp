#ifndef _pump_mask_BOX_INFO_HPP_
#define _pump_mask_BOX_INFO_HPP_
...
{
    template<>
    struct abi<pump_mask::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "B870934F-13C0-F27B-FCE1-4A82151B8FB6" };
    ...
    struct interface_vtable<Derived, pump_mask::box_info> : interface_vtable_base<Derived, pump_mask::box_info>
    {
    ...
    template <>
    struct abi_adapter<pump_mask::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_mask::box_info>
        {
