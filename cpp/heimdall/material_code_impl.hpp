...
namespace glasssix::heimdall
{
    ...
    class material_code_impl : public exposing::implements<material_code_impl, material_code>, public exposing::make_external_qualified_name<heimdall_material_code_qualified_name>
    {
    public:
        material_code_impl();
        ~material_code_impl();
