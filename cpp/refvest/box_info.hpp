...
{
    template<>
    struct abi<refvest::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "3510A56E-A928-4102-87F9-97CDF79D884E" };
    ...
    struct interface_vtable<Derived, refvest::box_info> : interface_vtable_base<Derived, refvest::box_info>
    {
    ...
    template <>
    struct abi_adapter<refvest::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, refvest::box_info>
        {
