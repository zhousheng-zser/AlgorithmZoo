...
namespace glasssix::brionac
{
	...
	exposing::param_vector<brionac::box_info> classify_code_impl::detect(exposing::param_span<std::uint8_t> bitmap, int channels, 
	...
	{
		if (!impl_)
			throw exposing::abi_invalid_operation(u8"brionac internal object not initialized");
