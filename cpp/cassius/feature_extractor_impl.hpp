...
{
	inline constexpr exposing::utf8_string_view cassius_feature_extractor_qualified_name{ u8"g6.cassius.featureExtractor" };

	class feature_extractor_internal;

	class feature_extractor_impl : public exposing::implements<feature_extractor_impl, feature_extractor>, public exposing::make_external_qualified_name<cassius_feature_extractor_qualified_name>
	{
	public:
		feature_extractor_impl();
		~feature_extractor_impl();
		void init(const exposing::param_string& racy_path, std::int32_t device, bool use_int8);
