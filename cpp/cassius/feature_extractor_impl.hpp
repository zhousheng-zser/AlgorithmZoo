...
{
	inline constexpr exposing::utf8_string_view gaius_feature_extractor_qualified_name{ u8"g6.cassius.featureExtractor" };
	...
	public:
		...
		void init(exposing::param_span<const exposing::param_string> phai, const exposing::param_string& racy_path, std::int32_t device, bool use_int8);
