...
{
	struct cassius_feature;
}

namespace glasssix::exposing::impl
{
	template<> struct abi<cassius::cassius_feature>
	{
		using identity_type = type_identity_interface;

		static constexpr guid id{ "360A2E61-8561-44A7-A5CE-82D768F7ED61" };
	...
	struct interface_vtable<Derived, cassius::cassius_feature> : interface_vtable_base<Derived, cassius::cassius_feature>
	{
	...
	template<> struct abi_adapter<cassius::cassius_feature>
	{
		template<typename Derived>
		struct type : enable_self_abi_awareness<Derived, cassius::cassius_feature>
		{
...
namespace glasssix::cassius
{
	struct cassius_feature : exposing::inherits<cassius_feature>
	{
