...
namespace glasssix::head
{
	...
	exposing::param_vector<head::box_info> detect_code_impl::detect(exposing::param_span<std::uint8_t> bitmap, int channels,
	...
	{
		if (!impl_)
			throw exposing::abi_invalid_operation(u8"head internal object not initialized");
