#ifndef __TXT_CODE_INTERNAL_HPP__
#define __TXT_CODE_INTERNAL_HPP__
...
namespace glasssix::genocr
{
    ...
    public:
        ...
        txt_code_internal(std::string_view model_directory, std::string_view chardic_directory, int factory_type, int device, std::map<std::string, float>& param_map);

        /// <summary>
        /// The copy constructor must be disabled in PImpl pattern.
        /// </summary>
        txt_code_internal(const txt_code_internal &) = delete;

        /// <summary>
        /// Destroys the instance.
        /// </summary>
        virtual ~txt_code_internal();

        /// <summary>
        /// The copy assignment operator must be disabled in PImpl pattern.
        /// </summary>
        txt_code_internal &operator=(const txt_code_internal &) = delete;
