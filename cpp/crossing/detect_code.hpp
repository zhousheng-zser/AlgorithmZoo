#ifndef _CROSSING_DETECT_CODE_HPP_
#define _CROSSING_DETECT_CODE_HPP_
...
{
    template <>
    struct abi<crossing::detect_code>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "1D5BC78A-93BF-4011-92A1-037688BB8013" };
    ...
    struct interface_vtable<Derived, crossing::detect_code> : interface_vtable_base<Derived, crossing::detect_code>
    {
    ...
    template <>
    struct abi_adapter<crossing::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, crossing::detect_code>
        {
