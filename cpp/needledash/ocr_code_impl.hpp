#ifndef __NEEDLEDASH_OCR_CODE_IMPL_HPP__
#define __NEEDLEDASH_OCR_CODE_IMPL_HPP__
...
{
    inline constexpr exposing::utf8_string_view needledash_ocr_code_qualified_name{ u8"g6.needledash.ocr_code" };

    class ocr_code_internal;

    class ocr_code_impl : public exposing::implements<ocr_code_impl, ocr_code>, public exposing::make_external_qualified_name<needledash_ocr_code_qualified_name>
    {
    public:
        ocr_code_impl();
        ~ocr_code_impl();
