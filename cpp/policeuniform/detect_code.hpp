#ifndef _POLICEUNIFORM_DETECT_CODE_HPP_
#define _POLICEUNIFORM_DETECT_CODE_HPP_
...
{
    template <>
    struct abi<policeuniform::detect_code>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "C5C55505-F601-4EF2-B3C5-4F2C306DD031" };
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                abi_out_t<exposing::param_vector<policeuniform::box_info>> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, policeuniform::detect_code> : interface_vtable_base<Derived, policeuniform::detect_code>
    {
        ...
        virtual std::int32_t G6_ABI_CALL detect(abi_in_t<param_span<std::uint8_t>> bitmap,
            ...
            std::int32_t roi_height,
            abi_in_t<exposing::param_hash_map<exposing::param_string, float>> param_map_abi,
            abi_out_t<exposing::param_vector<policeuniform::box_info>> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<policeuniform::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, policeuniform::detect_code>
        {
            ...
            exposing::param_vector<policeuniform::box_info> detect(
            ...
            {
                exposing::param_vector<policeuniform::box_info> result{ nullptr };
