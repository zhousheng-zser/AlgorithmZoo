#ifndef __SMOG_BOX_INFO_IMPL_HPP__
#define __SMOG_BOX_INFO_IMPL_HPP__
...
{
    inline constexpr exposing::utf8_string_view call_box_info_qualified_name{ u8"g6.smog.boxInfo" };
