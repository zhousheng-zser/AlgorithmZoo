...
namespace glasssix::longinus
{
	...
	public:
		...
		void init(exposing::param_string racy_path, float nms_threshold, std::int32_t device);
		void init(exposing::param_span<const exposing::param_string> phai, exposing::param_string racy_path, float nms_threshold, std::int32_t device);
