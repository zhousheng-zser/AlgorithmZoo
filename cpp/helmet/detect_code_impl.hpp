#ifndef __HELMET_DETECT_CODE_IMPL_HPP__
#define __HELMET_DETECT_CODE_IMPL_HPP__
...
{
    inline constexpr exposing::utf8_string_view helmet_detect_code_qualified_name{ u8"g6.helmet.detect_code" };

    class detect_code_internal;

    class detect_code_impl : public exposing::implements<detect_code_impl, detect_code>, public exposing::make_external_qualified_name<helmet_detect_code_qualified_name>
    {
    public:
        detect_code_impl();
        ~detect_code_impl();
		void init(const exposing::param_string& model_directory);
