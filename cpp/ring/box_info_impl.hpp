...
{
    inline constexpr exposing::utf8_string_view heimdall_box_info_qualified_name{u8"g6.ring.boxInfo"};
    ...
    public:
		...
		exposing::param_vector<exposing::param_string> messages() const;
        float angle() const;
