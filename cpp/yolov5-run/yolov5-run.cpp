...
#include "yolov5/yolov5m_net.hpp"
...
int main()
{
	...
	try
	{
		bool isOk = glasssix::exposing::get_component_loader().add_module_by_name("yolov5");

		auto yolov5_object = glasssix::exposing::make_exported_interface<glasssix::yolov5::yolov5m_net>(
		...
		auto ret = yolov5_object.detect(img_span, img.channels(), img.rows, img.cols, 1);
